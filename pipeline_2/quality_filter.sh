...
output1=$(echo ${input1}| sed "s|\.1\.fastq|\.filtered\.1\.fastq|g"| sed "s|0${PREVIOUS_STEP}_|0${STEP}_|g")
output2=$(echo ${input2}| sed "s|\.2\.fastq|\.filtered\.2\.fastq|g"| sed "s|0${PREVIOUS_STEP}_|0${STEP}_|g")
